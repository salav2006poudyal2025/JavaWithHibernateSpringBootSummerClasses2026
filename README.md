...
MySpringWeb was developed as an Enterprise Web Systems / Spring Boot project demonstrating practical Java, Spring, database, security, API, cloud-service, testing, containerization, and deployment concepts.
